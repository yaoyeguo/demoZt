...
<div class="layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      <a href="category_list.php"><li>栏目列表</li></a>
      <?php if($result){?>
      <a href="category_add.php"><li class="layui-this">更新栏目</li></a>
      <?php }else{?>
      <a href="category_add.php"><li class="layui-this">添加栏目</li></a>
      <?php }?>
...
<!--                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline input-custom-width">
                    <input type="text" name="name" value="<?php echo $result['cat_name']?>" lay-verify="required" autocomplete="off" placeholder="请输入栏目名称" class="layui-input">
                  </div>
                </div>
...
layui.use(['element', 'form', 'upload'], function(){
  ...
  form.on('submit(cate_add)', function(data){
    ...
    jq.post('./categoryAdd.php',param,function(data){
      var data = eval('('+data+')');
      if(data.code == 0){
        layer.close(loading);
